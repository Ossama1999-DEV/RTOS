/**!
 * \file systeme.c
 * \brief Gestion du système d'ordonnancement
...
//val_tos re�oit l'adresse de la fonction
//puc pointe sur l'octet poid faible
//TOS est mis � jour octet par octet
...
{
// Sauvegarde de registres sensibles (ils sont modifi�s au cours du changement de tache)
...
// Debut de sauvegarde des zones utilis�es par le compilateur
// FSR1 va servir � balayer la zone 0x00 � 0x2F
        FSR1H=0;
        FSR1L=0;
        ...
        POSTINC0=POSTINC1;POSTINC0=POSTINC1;POSTINC0=POSTINC1;POSTINC0=POSTINC1;
        POSTINC0=POSTINC1;POSTINC0=POSTINC1;POSTINC0=POSTINC1;POSTINC0=POSTINC1;
// Fin de sauvegarde des zones utilis�es par le compilateur
...
// FSR1 va servir � balayer la zone 0x00 � 0x2F
        ...
        FSR1L=0;
        FSR0H=tache_active;
        FSR0L=18;// acces � la zone compilateur de la tache � restaurer
...
//acc�s � la zone du contexte (partie registres) de la tache
        FSR0H=tache_active;
        FSR0L=0;
...
void initialisation_du_systeme(void)
{
    ...
    tache_active=queue[pointeur_de_tache];
    // d�marrage en tache 6
    // la premi�re tache ex�cut�e sera la tache 1

    /* Cr�ation de la pile associ�e au taches */
    temp=STKPTR;
